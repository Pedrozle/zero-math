                  ...
                  child: Column(children: [
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 40, bottom: 8, right: 8, left: 8),
                      child: Text(
                        explicacao,
                        ...
                        child: Center(
                          child: Column(children: [
                            ...
                            DataTable(
                              ...
                              columns: [
                                DataColumn(
                                    label: Text(widget.data.tabela[0][0])),
                                DataColumn(
                                    label: Text(widget.data.tabela[0][1])),
                                DataColumn(
                                    label: Text(widget.data.tabela[0][2])),
                                DataColumn(
                                    label: Text(widget.data.tabela[0][3])),
                                DataColumn(
                                    label: Text(widget.data.tabela[0][4])),
                              ],
                              rows: [
                                DataRow(cells: [
                                  DataCell(Text(
                                      widget.data.tabela[1][0].toString())),
                                  DataCell(Text(
                                      widget.data.tabela[1][1].toString())),
                                  DataCell(Text(
                                      widget.data.tabela[1][2].toString())),
                                  DataCell(Text(
                                      widget.data.tabela[1][3].toString())),
                                  DataCell(Text(
                                      widget.data.tabela[1][4].toString())),
                                ]),
                              ],
                            ),
                          ]),
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: DataTable(
                                    ...
                                    columns: [
                                      DataColumn(
                                          label:
                                              Text(widget.data.tabela[2][0])),
                                      DataColumn(
                                          label:
                                              Text(widget.data.tabela[2][1])),
                                      DataColumn(
                                          label:
                                              Text(widget.data.tabela[2][2])),
                                      DataColumn(
                                          label:
                                              Text(widget.data.tabela[2][3])),
                                      DataColumn(
                                          label:
                                              Text(widget.data.tabela[2][4])),
                                    ],
                                    rows: [
                                      for (int i = 3;
