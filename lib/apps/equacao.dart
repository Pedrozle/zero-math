                    ...
                    children: [
                      ...
                      if (!vazio)
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            DetailsData data = DetailsData(widget.typeScreen,
                                equacao, dataGraph, dataRaizes, tabela);
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                      ...
                      Row(children: [
                        ...
                        Expanded(
                          ...
                          decoration: InputDecoration(
                            ...
                            filled: true,
                            labelText:
                                widget.typeScreen == 4 || widget.typeScreen == 5
                                    ? 'Chute Inicial'
                                    : 'Limite Final',
                            hintText: widget.typeScreen == 4
                                ? "2.5"
                        ...
                        children: [
                          Expanded(
                            ...
                            onPressed: () async {
                              ...
                              MyRequest obj = MyRequest(
                                  1, "equacao", "equacaoDerivada", 1, 1, 1, 1);
                              ...
                              if (precisaoController.text.isEmpty) {
                                ...
                                precisao =
                                    double.parse(precisaoController.text);
                              }
                              ...
                              switch (widget.typeScreen) {
                                case 4:
                                  ...
                                  obj = MyRequest(4, equacao, funcao, chute, 0,
                                      precisao, reps);
                                  break;
                                ...
                                case 5:
                                  ...
                                  obj = MyRequest(5, equacao, funcao, chute, 0,
                                      precisao, reps);
                                  break;
                                ...
                                default:
                                  ...
                                  obj = MyRequest(widget.typeScreen, equacao,
                                      '', pontoA, pontoB, precisao, reps);
                                  break;
                              }
                            ...
                            ? Column(
                                ...
                                children: [
                                  ...
                                  raizes.isNotEmpty
                                      ...
                                      : const Text(
                                          "O intervalo atual não possui raízes"),
                                  const SizedBox(
                                    height: 8,
                                  ),
                                  SizedBox(
                                  ...
                                  const Text(
                                      "Experimente alterar os valores informados!"),
                                ],
                              )
                            : const Column(
                                children: [
                                  Text(
                                      "Insira os dados acima para visualizar o gráfico"),
                                ],
                              ),
                      )
                    ],
